...
def network_portrayal(G):
    ...
    # if disease can be transmitted down an edge, draw the line solid, else grey
...
model_params = {
    ...
    'avg_node_degree': UserSettableParameter('slider', 'Average Node Degree', 6, 3, 30, 1,
                                             description='Average Node Degree'),
    'prob_rewire': UserSettableParameter('slider', 'Rewire Probability', 0.2, 0, 1, 0.01,
...
server = ModularServer(VirusModel, [network, chart, *text], 'Revolution on a Network', model_params)
server.port = 8521