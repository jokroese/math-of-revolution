class Game {
  ...
  void init() {
    for (int i = 0; i < columns; i++) {
      ...
      //create one defecting cell in the middle
        ...
        //if(i==int(columns/2)-1&&j==int(rows/2)-1) {
        //    board[i][j] = new Cell(i*w, j*w, w, true);
        //}
        //else if(i==int(columns/2)-1&&j==int(rows/2)) {
        //    board[i][j] = new Cell(i*w, j*w, w, true);
        //}
        //else if(i==int(columns/2)-1&&j==int(rows/2)+1) {
        //    board[i][j] = new Cell(i*w, j*w, w, true);
        //}
        //else if(i==int(columns/2)&&j==int(rows/2)-1) {
        //    board[i][j] = new Cell(i*w, j*w, w, true);
        //}
        //else if(i==int(columns/2)&&j==int(rows/2)) {
        //    board[i][j] = new Cell(i*w, j*w, w, true);
        //}
        //else if(i==int(columns/2)&&j==int(rows/2)+1) {
        //    board[i][j] = new Cell(i*w, j*w, w, true);
